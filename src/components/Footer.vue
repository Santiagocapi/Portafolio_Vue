<template>
  <footer class="footer">
    <div class="footer-content">
      <div class="footer-section">
        ...
        <div class="social-links">
          <a
            href="https://www.instagram.com/santiagocapitani/"
            target="_blank"
          ...
          <a href="https://x.com/santicapitani" target="_blank" aria-label="X (Twitter)">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path
      ...
      <div class="footer-section">
        ...
        <div class="tech-attribution">
          <span>Puedes ver el código fuente en</span>
          <a
            href="https://github.com/Santiagocapi/portafolio_vue"
            target="_blank"
            aria-label="GitHub"
          >
            <svg
    ...
    <div class="footer-bottom">
      <p>&copy; 2025 Santiago Capitani. Todos los derechos reservados.</p>
    </div>
  </footer>
</template>
